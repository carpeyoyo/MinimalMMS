...
public class PduPart {
    ...
    /**
     ...
     /**
      * Set data uri. The data is stored as Uri.
      *
      * @param uri the uri
      */
    ...
    /**
     * Set data path. This path will be placed as _data in the database
     *
     * @param uriPath The path to save under _data.
     */
     ...
     *
     * @return The path to store under _data
     */
    ...
    /**
      ...
      *
      * @param contentTransferEncoding the byte array for content transfer encoding header
      * @throws NullPointerException if the value is null.
      */
